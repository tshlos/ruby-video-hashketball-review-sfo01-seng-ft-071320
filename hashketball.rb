...
def team_names
  ...
  teams.push(team_away, team_home)
end
...
def team_numbers(team_name, location)
  ...
  if team == team_name
    player_num = game_hash[location][:players].map { |player| player[:number] }
    return player_num
  end
end
...
def player_stats(name)
  player_name = game_hash[:home][:players]
  binding.pry
  if player_name[:player_name] == name
    player = game_hash[:home][:players].each { |attribute| puts attribute }
    binding.pry
  end
end
